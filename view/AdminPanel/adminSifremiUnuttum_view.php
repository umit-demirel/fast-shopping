...
<html>
  <head>
    ...
    <title>Şifrenizi Mi Unuttunuz?</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="javascript:void()"><b>Şifrenizi Mi Unuttunuz?</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Hatırlatma Şifresi İçin E-mail Adresinizi Giriniz!</p>
        <form action="<?php echo SITE_URL; ?>/admin/sifremi_unuttum" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary">Hatırlatma E-Postası Gönder</button> 
            </div><!-- /.col -->
