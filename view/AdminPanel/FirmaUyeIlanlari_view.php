...
<section class="content">
	<div class="box">
		<div class="box-body">
			...
			<form action="<?php echo SITE_URL; ?>/AdminIlanlar/firma_ilan_ara" method="post">
			...
			foreach($ilanlar as $value)
			{
				...
				$firma_id = $value["FirmaID"];
				$urun_adi = $value["UrunAdi"];
				...
				{
					$ilan_durumu = "<a href='".SITE_URL."/AdminIlanlar/firma_ilan_aktif/$urun_id' class='btn btn-success'><i class='fa fa-check'></i> Onayla</a>";
				}else{
					$ilan_durumu = "<a href='".SITE_URL."/AdminIlanlar/firma_ilan_pasif/$urun_id' class='btn btn-warning'><i class='fa fa-check'></i> Pasif Yap</a>";
				}
				echo "
					<tr>
					<td width='5%' style='padding:5px;' align='center'>
					...
					<td width='25%' align='center'>
						<a href='".SITE_URL."/AdminUye/firma_uye_profili/$firma_id' class='btn btn-default'><i class='fa fa-user'></i> İlan Sahibi</a>
						
						$ilan_durumu
						
						<a href='".SITE_URL."/AdminIlanlar/firma_ilan_sil/$urun_id' class='btn btn-danger'><i class='fa fa-remove'></i> Sil</a>
					</td>
					</tr>
				";
